...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  patches: {
    ...
    apply: (servicePath, serviceId, name) => ipcRenderer.invoke('patch:apply', { servicePath, serviceId, name }),
    resetToHead: (servicePath, serviceId, name) => ipcRenderer.invoke('patch:reset-to-head', { servicePath, serviceId, name }),
